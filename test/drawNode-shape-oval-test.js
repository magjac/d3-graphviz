...
tape("Verify that oval shape is drawn exactly as Graphviz does.", function(test) {
    ...
    expectedGraphviz
        .zoom(false)
        .renderDot('digraph {a [shape="oval"]}', function () {
            actualGraphviz
                .renderDot('digraph {}', function () {
                    var x = 27;
                    var y = -18;
                    actualGraphviz
                        .drawNode(x, y, null, null, 'oval', 'a', {id: 'node1'})
                        .insertDrawnNode('a');
