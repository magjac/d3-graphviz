...
tape("Verify that diamond shape is drawn exactly as Graphviz does.", function(test) {
    ...
    expectedGraphviz
        .zoom(false)
        .renderDot('digraph {a [shape="diamond"]}', function () {
            actualGraphviz
                .renderDot('digraph {}', function () {
                    var x = 27;
                    var y = -18;
                    actualGraphviz
                        .drawNode(x, y, null, null, 'diamond', 'a', {id: 'node1'})
                        .insertDrawnNode('a');
