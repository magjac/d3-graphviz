...
tape("Check our understanding of how Graphviz draws nodes.", async function (test) {
...
tape("drawNode() draws a node in the same way as Graphviz does", async function (test) {
    var window = global.window = jsdom('<div id="graph"></div>');
    var document = global.document = window.document;
    var graphviz;
...
tape("drawNode() draws a polygon node", async function (test) {
    var window = global.window = jsdom('<div id="graph"></div>');
    var document = global.document = window.document;
    var graphviz;
...
tape("drawNode() draws a node with an URL attribute in the same way as Graphviz does", async function (test) {
    var window = global.window = jsdom('<div id="graph"></div>');
    var document = global.document = window.document;
    var graphviz;
...
tape("drawNode() draws a node with an tooltip attribute in the same way as Graphviz does", async function (test) {
    var window = global.window = jsdom('<div id="graph"></div>');
    var document = global.document = window.document;
    var graphviz;
...
tape("insertDrawnNode() inserts the currently drawn node into the joined data structure so that it can be animated when the graph is re-rendered", async function (test) {
    var window = global.window = jsdom('<div id="graph"></div>');
    var document = global.document = window.document;
    var graphviz;
...
tape("removeDrawnNode() removes the node currently being drawn", async function (test) {
    var window = global.window = jsdom('<div id="graph"></div>');
    var document = global.document = window.document;
    var graphviz;
...
tape("updateDrawnNode modifies the position, size and attributes of a node", async function (test) {
    var window = global.window = jsdom('<div id="graph"></div>');
    var document = global.document = window.document;
    var graphviz;
...
tape("moveDrawnNode modifies the position of a node", async function (test) {
    var window = global.window = jsdom('<div id="graph"></div>');
    var document = global.document = window.document;
    var graphviz;
...
tape("drawnNodeSelection return a selection containing the node currently being drawn", async function (test) {
    var window = global.window = jsdom('<div id="graph"></div>');
    var document = global.document = window.document;
    var graphviz;
...
tape("Attempts to operate on a node without drawing one first is handled gracefully", async function (test) {
    var window = global.window = jsdom('<div id="graph"></div>');
    var document = global.document = window.document;
    var graphviz;
