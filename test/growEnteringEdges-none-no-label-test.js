...
tape("graphviz().render() renders growing edges from nodes with shape none and no labels.", async function (test) {
    ...
    await new Promise(resolve => {
        graphviz
            ...
            .zoom(false)
            .renderDot('digraph {a [shape="none" label=""]; b}', resolve);
    });
    ...
    await new Promise(resolve => {
        graphviz
            .renderDot('digraph {a [shape="none" label=""]; b; a -> b}', resolve);
    });
