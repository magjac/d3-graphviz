...
tape("Verify that box shape is drawn exactly as Graphviz does.", async function (test) {
    ...
    await new Promise(resolve => {
        expectedGraphviz
            .zoom(false)
            .renderDot('digraph {a [shape="box"]}', resolve);
    });
    ...
    var y = -18;
    actualGraphviz
        .drawNode(x, y, 'a', { shape: 'box', id: 'node1' })
        .insertDrawnNode('a');
