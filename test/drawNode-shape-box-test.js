...
tape("Verify that box shape is drawn exactly as Graphviz does.", function(test) {
        ...
        .renderDot('digraph {a [shape="box"]}', function () {
            actualGraphviz
                .renderDot('digraph {}', function () {
                    actualGraphviz
                        .drawNode(0, -36, 54, 36, 'box', 'a', {id: 'node1'})
                        .insertDrawnNode('a');
                    ...
                    test.equal(actualNodeShape.attr("points"), expectedNodeShape.attr("points"), 'points of polygon');
