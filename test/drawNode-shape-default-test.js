...
it("Verify that default shape is drawn exactly as Graphviz does.", html, () => new Promise(resolve => {
...
it("Verify that default shape with style filled is drawn exactly as Graphviz does.", html, () => new Promise(resolve => {
    var expectedGraph = d3_select("#expected-graph");
    var actualGraph = d3_select("#actual-graph");
    var actualGraphviz;
    var expectedGraphviz = d3_graphviz("#expected-graph")
...
it("Default shape with style filled without fillcolor, but with color, uses color as fillcolor.", html, () => new Promise(resolve => {
    var expectedGraph = d3_select("#expected-graph");
    var actualGraph = d3_select("#actual-graph");
    var actualGraphviz;
    var expectedGraphviz = d3_graphviz("#expected-graph")
...
it("Verify that default shape with label is drawn exactly as Graphviz does.", html, () => new Promise(resolve => {
    var expectedGraph = d3_select("#expected-graph");
    var actualGraph = d3_select("#actual-graph");
    var actualGraphviz;
    var expectedGraphviz = d3_graphviz("#expected-graph")
