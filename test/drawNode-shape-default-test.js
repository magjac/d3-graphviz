        ...
        .renderDot('digraph {a}', function () {
            actualGraphviz
                .renderDot('digraph {}', function () {
                    ...
                    var y = -18
                    actualGraphviz
                        .drawNode(x, y, null, null, null, 'a', {id: 'node1'})
                        .insertDrawnNode('a');
        ...
        .renderDot('digraph {a [style=filled]}', function () {
            actualGraphviz
                .renderDot('digraph {}', function () {
                    ...
                    var y = -18
                    actualGraphviz
                        .drawNode(x, y, null, null, null, 'a', {id: 'node1', style: 'filled'})
                        .insertDrawnNode('a');
        ...
        .renderDot('digraph {a [style=filled color="#0000ff"]}', function () {
            actualGraphviz
                .renderDot('digraph {}', function () {
                    ...
                    var y = -18
                    actualGraphviz
                        .drawNode(x, y, null, null, null, 'a', {id: 'node1', style: 'filled', color: '#0000ff'})
                        .insertDrawnNode('a');
        ...
        .renderDot('digraph {a [label="x"]}', function () {
            actualGraphviz
                .renderDot('digraph {}', function () {
                    ...
                    var y = -18
                    actualGraphviz
                        .drawNode(x, y, null, null, null, 'a', {id: 'node1', label: 'x'})
                        .insertDrawnNode('a');
