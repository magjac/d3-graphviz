...
it("Verify that cylinder shape is drawn exactly as Graphviz does.", html, () => new Promise(resolve => {
                ...
                actualGraphviz
                    .renderDot('digraph {}', function () {
                        ...
                        actualNodeShapes.each(function(d, i, nodes) {
                            var actualNodeShape = d3_select(this);
                            var expectedNodeShape = d3_select(expectedNodeShapes.nodes()[i]);
